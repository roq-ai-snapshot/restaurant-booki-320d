  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless table reservations and efficient management with Restaurant Booking Engine, your comprehensive solution for restaurant operations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless table reservations and efficient management with Restaurant Booking Engine, your comprehensive solution for restaurant operations.`}
            </Text>
            <Box
